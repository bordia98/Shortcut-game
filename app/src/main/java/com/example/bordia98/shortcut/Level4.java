...
public class Level4 extends AppCompatActivity {
    ...
    public int usershortest(){
        if(b0.isEnabled()==false &&b6.isEnabled()==true && b1.isEnabled()==false&&b5.isEnabled()==true && b3.isEnabled()==false &&b2.isEnabled()==false&&b4.isEnabled()==true)
            x=a[0]+a[1]+a[2];
        else if(b0.isEnabled()==false &&b6.isEnabled()==false && b1.isEnabled()==true&&b5.isEnabled()==true && b3.isEnabled()==false &&b2.isEnabled()==false&&b4.isEnabled()==true)
            x=a[6]+a[8]+a[2];
        else if(b0.isEnabled()==false &&b6.isEnabled()==false && b1.isEnabled()==true&&b5.isEnabled()==false && b3.isEnabled()==false &&b2.isEnabled()==true&&b4.isEnabled()==false)
            x=a[6]+a[7]+a[3]+a[4];
        else if(b0.isEnabled()==false &&b6.isEnabled()==true && b1.isEnabled()==true&&b5.isEnabled()==false && b3.isEnabled()==false &&b2.isEnabled()==true&&b4.isEnabled()==false)
            x=a[5]+a[3]+a[4];
        else if(b0.isEnabled()==false &&b6.isEnabled()==false && b1.isEnabled()==true&&b5.isEnabled()==false && b3.isEnabled()==false &&b2.isEnabled()==false&&b4.isEnabled()==true)
            x=a[5]+a[7]+a[8]+a[2];
        else
            return  -1;
        return x;
