...
public class Level6 extends AppCompatActivity {
    ...
    public int usershortest(){
        ...
        if(b0.isEnabled()==false&&b1.isEnabled()==true&&b2.isEnabled()==true&&b3.isEnabled()==false&&b4.isEnabled()==false&&b5.isEnabled()==true&&b6.isEnabled()==false){
            x = a[6]+a[10]+a[3];
            return x;
        }
        ...
        if(b0.isEnabled()==false&&b1.isEnabled()==false&&b2.isEnabled()==true&&b3.isEnabled()==false&&b4.isEnabled()==false&&b5.isEnabled()==true&&b6.isEnabled()==false){
            x = a[0]+a[10]+a[9]+a[3];
            return x;
        }
        if(b0.isEnabled()==false&&b1.isEnabled()==true&&b2.isEnabled()==false&&b3.isEnabled()==false&&b4.isEnabled()==false&&b5.isEnabled()==false&&b6.isEnabled()==false){
            x = a[5]+a[4]+a[10]+a[8]+a[2];
            return x;
        }
        if(b0.isEnabled()==false&&b1.isEnabled()==false&&b2.isEnabled()==false&&b3.isEnabled()==false&&b4.isEnabled()==false&&b5.isEnabled()==true&&b6.isEnabled()==false){
            x = a[0]+a[1]+a[10]+a[8]+a[3];
            return x;
        }
