...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        restart.setTranslationY(1000f);
        nextlevel.setTranslationY(1000f);
        check.setTranslationY(1000f);
        nextlevel.animate().translationY(0f).setDuration(200);
        check.animate().translationY(0f).setDuration(200);
        restart.animate().translationY(0f).setDuration(200);
